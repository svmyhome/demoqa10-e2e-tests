...
#
# with open(
#     os.path.join(PROJECT_ROOT_PATH, '../resources/pytest_logo_curves.svg'), 'wb'
# ) as image_file:
...
#         print(r.url)
#
# with open(os.path.join(PROJECT_ROOT_PATH, '../resources/LICENSE'), 'wb') as text_file:
...
#
# with open(os.path.join(PROJECT_ROOT_PATH, '../resources/AUTHOR'), 'wb') as text_file:
...
# browser.close()
#
# with open(os.path.join(PROJECT_ROOT_PATH, '../resources/README.rst')) as file:
#     # print(file.read())
